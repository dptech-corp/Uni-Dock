...
cmdline = "/root/Vina1.2-GPU/build/linux/release/vina --receptor /DB/forDockGPU-LITPCBA/FEN1/FEN1.pdbqt --dir /tmp/ --scoring vina --center_x 9.558 --center_y 48.5815 --center_z 89.006 --size_x 21.556 --size_y 18.677 --size_z 27.258 --seed 181129 --max_step 20 --exhaustiveness 128 --num_modes 1  --verbosity 0 --max_gpu_memory 31000"
...
def run_speed_test(nt, ns):
    info = []
    os.chdir("/root/Vina1.2-GPU/speed/pdbqt")
    ...
    with open("../results/nt" + str(nt) + "-ns" + str(ns) + ".csv", "w") as f:

...
public:
    ...
    void global_search_gpu(const int exhaustiveness = 8, const int n_poses = 20,
                           ...
                           const bool local_only = false,const bool core_constraint=false,const float mobility=0.01);
    ...
    void write_score_to_file_with_mark(const std::vector<double> energies, const std::string out_dir,
                             const std::string score_file, const std::string input_name); 
    void write_score_to_file(const std::vector<double> energies,
                             const std::string score_file, const std::string input_name);
    void write_score_to_file_with_mark(const std::vector<double> energies,
                             const std::string score_file, const std::string input_name);                          
    ...
    void conf_exhaustion_with_torsion_range( sz max_steps,vec center,vec box_size,sz numSamples,std::string out_dir,std::string out_name,std::string ligand_name);

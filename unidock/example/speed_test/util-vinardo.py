...
cmdline = "vina --receptor ../protein/FEN1.pdbqt --dir /tmp/ --scoring vinardo --center_x 9.558 --center_y 48.5815 --center_z 89.006 --size_x 21.556 --size_y 18.677 --size_z 27.258 --seed 181129 --max_step 20 --exhaustiveness 128 --num_modes 1  --verbosity 0 --max_gpu_memory 31000"
...
def calc(ntorsions, natoms, nt, ns, cmd, filename):
    ...
    batch_size = int((30000.0-20017.0)/(1.214869+0.0038522*nt+0.011978*natoms*natoms))
...
def run_speed_test(nt, ns):
    ...
    os.makedirs("../results-vinardo", exist_ok=True)
    with open("../results-vinardo/nt" + str(nt) + "-ns" + str(ns) + ".csv", "w") as f:
